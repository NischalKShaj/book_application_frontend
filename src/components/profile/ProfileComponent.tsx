          ...
          <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div className="px-5 pb-5">
              ...
              <ul className="text-gray-700 dark:text-gray-300 space-y-2">
                <li>
                  <span className="font-semibold">Full Address: </span>123, Main
                  Street, Building A
                </li>
                <li>
                  <span className="font-semibold">Locality: </span>Green Park
                </li>
                <li>
                  <span className="font-semibold">City: </span>New York
                </li>
                <li>
                  <span className="font-semibold">State: </span>New York
                </li>
                <li>
                  <span className="font-semibold">Pincode: </span>10001
                </li>
              </ul>
            </div>
          </div>
